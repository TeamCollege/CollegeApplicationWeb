...
<body>
	...
	<center>
		...
		%>
		<form name="login" action="StudentInfoServlet"
			onsubmit="return validation()" method="get">

			<h3>Student Id:</h3>
			<input type="text" name="studentid" id="sid" value="<%=uName%>"
