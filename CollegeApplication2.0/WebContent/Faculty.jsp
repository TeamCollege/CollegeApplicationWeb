					...
					<div class="buttons">
						...
						<div class="row">
							...
							<div class="col-md-4 col-md-12">
								...
								<a tabindex="-1" href="ViewCoursesStud.jsp?username=<%=uName%>">Courses</a><br />
							...
							<div class="col-md-4 col-md-12">
								<a tabindex="-1" href="EventStudent.jsp">Events</a><br /> <br />
								<a tabindex="-1" href="BasicFaculty.jsp?username=<%=uName%>">FacultyInfo</a><br />
								<br /> <a tabindex="-1" href="ShowAllAlumniStud.jsp">AlumniList</a>
							</div>
							<div class="col-md-4 col-md-12">
								<a tabindex="-1" href="ClassSchedule.html">ClassSchedule</a><br />
								<br /> <a tabindex="-1" href="ExamScheduleStudent.html">ExamSchedule</a><br />
								<a tabindex="-1"
									href="FeedbackMain.jsp?username=<%=uName%>&userType=<%=uType%>">FeedBAck</a><br />
