...
<form name="myForm" action="FacultyInfoServlet" onsubmit="return validation()" method="get">
<center>
  <h3>Employee Id:</h3>
  <input type="text" name="empno" id="emp" value="<%=uName%>" readonly="readonly">
  <h3>First name:</h3>
