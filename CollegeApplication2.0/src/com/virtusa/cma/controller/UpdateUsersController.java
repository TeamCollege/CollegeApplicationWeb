...
/**
 * Servlet implementation class UpdateUsersController
 */
public class UpdateUsersController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = userServiceIface.updateUser(users);
		
		request.setAttribute("res",result);
		RequestDispatcher rs = request.getRequestDispatcher("UserUpdateCall.jsp");
